...
### @id (Automated)
- **Type:** URL
- **Format:** `https://ucospo.net/education/lessons/{slug}`
- **Required:** YES
- **Fill rate:** 0% → 100% ✅
- **Example:** `https://ucospo.net/education/lessons/building-community`
...
| `@id` | Bioschemas IRI | `https://ucospo.net/education/lessons/building-community` | Script |
...
- Points to YOUR lesson detail page (on ucospo.net/education)
- Example: `https://ucospo.net/education/lessons/building-community`
- Generated from `slug`
...
```json
{
  "@id": "https://ucospo.net/education/lessons/building-community",
